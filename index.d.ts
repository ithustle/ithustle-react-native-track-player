...
declare namespace RNTrackPlayer {
  ...
  export function setShuffle(shuffleEnabled: boolean): Promise<void>;
  export function repeat(repeatMode: number): Promise<void>;
  ...
  export function getShuffle(): Promise<void>;
